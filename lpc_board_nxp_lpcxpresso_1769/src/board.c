...
#define BUTTONS_BUTTON2_GPIO_BIT_NUM            12
...
void Board_Buttons_Init(void)
{
	...
	Chip_GPIO_WriteDirBit(LPC_GPIO, BUTTONS_BUTTON2_GPIO_PORT_NUM,
		BUTTONS_BUTTON2_GPIO_BIT_NUM, false);
}
...
uint32_t Buttons_GetStatus_of(void)
{
	uint8_t ret = NO_BUTTON_PRESSED;
	if (Chip_GPIO_ReadPortBit(LPC_GPIO, BUTTONS_BUTTON2_GPIO_PORT_NUM,
	BUTTONS_BUTTON2_GPIO_BIT_NUM) == 0x00)
	{
		ret |= BUTTONS_BUTTON2;
	}
	return ret;
